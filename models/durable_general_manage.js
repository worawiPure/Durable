...
module.exports = {
    ...
    save_asset_general: function (db,data) {
        ...
        db('general_asset')
            .insert({
                receive_date: data.receive_date2,
    ...
    search_durable_items: function(db,data){
        ...
        var sql =   'SELECT ADDDATE(a.distribute_date,INTERVAL 543 YEAR) as distribute_date_thai,ADDDATE(a.receive_date,INTERVAL 543 YEAR) as receive_date_thai,a.*,t.name as type_name,i.name as durable_name,CONCAT(i.code,"/",a.pieces) as items_code, '+
            'w.provide,o.shop as shop_name,r.name as room_name,s.name as status_name,r2.name as change_room_name,i.code  FROM  general_asset a '+
    ...
    search_durable_items_distribute: function(db,data){
        var q = Q.defer();
        var sql =   'SELECT ADDDATE(a.distribute_date,INTERVAL 543 YEAR) as distribute_date_thai,ADDDATE(a.receive_date,INTERVAL 543 YEAR) as receive_date_thai,a.*,t.name as type_name,i.name as durable_name,CONCAT(i.code,"/",a.pieces) as items_code, '+
            'w.provide,o.shop as shop_name,r.name as room_name,s.name as status_name,r2.name as change_room_name,i.code  FROM  general_asset a '+
            'LEFT JOIN general_type t ON t.id=a.durable_type '+
    ...
    search_durable_items_worn_out: function(db,data){
        var q = Q.defer();
        var sql =   'SELECT ADDDATE(a.distribute_date,INTERVAL 543 YEAR) as distribute_date_thai,ADDDATE(a.receive_date,INTERVAL 543 YEAR) as receive_date_thai,a.*,t.name as type_name,i.name as durable_name,CONCAT(i.code,"/",a.pieces) as items_code, '+
            'w.provide,o.shop as shop_name,r.name as room_name,s.name as status_name,r2.name as change_room_name,i.code  FROM  general_asset a '+
            'LEFT JOIN general_type t ON t.id=a.durable_type '+
    ...
    search_durable_type_distribute: function(db,data){
        var q = Q.defer();
        var sql =   'SELECT ADDDATE(a.distribute_date,INTERVAL 543 YEAR) as distribute_date_thai,ADDDATE(a.receive_date,INTERVAL 543 YEAR) as receive_date_thai,a.*,t.name as type_name,i.name as durable_name,CONCAT(i.code,"/",a.pieces) as items_code, '+
            'w.provide,o.shop as shop_name,r.name as room_name,s.name as status_name,r2.name as change_room_name,i.code  FROM  general_asset a '+
            'LEFT JOIN general_type t ON t.id=a.durable_type '+
    ...
    search_durable_type_worn_out: function(db,data){
        var q = Q.defer();
        var sql =   'SELECT ADDDATE(a.distribute_date,INTERVAL 543 YEAR) as distribute_date_thai,ADDDATE(a.receive_date,INTERVAL 543 YEAR) as receive_date_thai,a.*,t.name as type_name,i.name as durable_name,CONCAT(i.code,"/",a.pieces) as items_code, '+
            'w.provide,o.shop as shop_name,r.name as room_name,s.name as status_name,r2.name as change_room_name,i.code  FROM  general_asset a '+
            'LEFT JOIN general_type t ON t.id=a.durable_type '+
    ...
    search_durable_room_distribute: function(db,data){
        var q = Q.defer();
        var sql =   'SELECT ADDDATE(a.distribute_date,INTERVAL 543 YEAR) as distribute_date_thai,ADDDATE(a.receive_date,INTERVAL 543 YEAR) as receive_date_thai,a.*,t.name as type_name,i.name as durable_name,CONCAT(i.code,"/",a.pieces) as items_code, '+
            'w.provide,o.shop as shop_name,r.name as room_name,s.name as status_name,r2.name as change_room_name,i.code  FROM  general_asset a '+
            'LEFT JOIN general_type t ON t.id=a.durable_type '+
    ...
    search_durable_room_worn_out: function(db,data){
        var q = Q.defer();
        var sql =   'SELECT ADDDATE(a.distribute_date,INTERVAL 543 YEAR) as distribute_date_thai,ADDDATE(a.receive_date,INTERVAL 543 YEAR) as receive_date_thai,a.*,t.name as type_name,i.name as durable_name,CONCAT(i.code,"/",a.pieces) as items_code, '+
            'w.provide,o.shop as shop_name,r.name as room_name,s.name as status_name,r2.name as change_room_name,i.code  FROM  general_asset a '+
            'LEFT JOIN general_type t ON t.id=a.durable_type '+
    ...
    report_durable_distribute_items: function(db,items_print){
        var q = Q.defer();
        var sql =   'SELECT a.*,t.name as type_name,i.name as durable_name,CONCAT(i.code,"/",a.pieces) as items_code, '+
            'w.provide,o.shop as shop_name,r.name as room_name,s.name as status_name,r2.name as change_room_name,i.code  FROM  general_asset a '+
            'LEFT JOIN general_type t ON t.id=a.durable_type '+
    ...
    report_durable_distribute_room: function(db,room_print){
        var q = Q.defer();
        var sql =   'SELECT a.*,t.name as type_name,i.name as durable_name,CONCAT(i.code,"/",a.pieces) as items_code, '+
            'w.provide,o.shop as shop_name,r.name as room_name,s.name as status_name,r2.name as change_room_name  FROM  general_asset a '+
            'LEFT JOIN general_type t ON t.id=a.durable_type '+
    ...
    report_durable_items_distribute_price_total: function(db,items_print){
        var q = Q.defer();
        var sql =   'SELECT SUM(a.price) as total FROM general_asset a WHERE a.durable_items = ? AND a.status = 2 ';
        db.raw(sql,[items_print])
            //var sql = db.raw(sql,[data.date,data.username]).toSQL() คำสั่งเช็ค ค่า และคำสั่ง SQL
            .then(function(rows){
                q.resolve(rows[0][0].total)
    ...
    report_durable_items_worn_out_price_total: function(db,items_print){
        var q = Q.defer();
        var sql =   'SELECT SUM(a.price) as total FROM general_asset a WHERE a.durable_items = ? AND a.status = 5 ';
        db.raw(sql,[items_print])
            //var sql = db.raw(sql,[data.date,data.username]).toSQL() คำสั่งเช็ค ค่า และคำสั่ง SQL
            .then(function(rows){
                q.resolve(rows[0][0].total)
    ...
    report_durable_type_distribute_price_total: function(db,type_print){
        var q = Q.defer();
        var sql =   'SELECT SUM(a.price) as total FROM general_asset a WHERE a.durable_type = ? AND a.status = 2 ';
        db.raw(sql,[type_print])
            //var sql = db.raw(sql,[data.date,data.username]).toSQL() คำสั่งเช็ค ค่า และคำสั่ง SQL
            .then(function(rows){
                q.resolve(rows[0][0].total)
    ...
    report_durable_type_worn_out_price_total: function(db,type_print){
        var q = Q.defer();
        var sql =   'SELECT SUM(a.price) as total FROM general_asset a WHERE a.durable_type = ? AND a.status = 5 ';
        db.raw(sql,[type_print])
            //var sql = db.raw(sql,[data.date,data.username]).toSQL() คำสั่งเช็ค ค่า และคำสั่ง SQL
            .then(function(rows){
                q.resolve(rows[0][0].total)
    ...
    report_durable_room_distribute_price_total: function(db,room_print){
        var q = Q.defer();
        var sql =   'SELECT SUM(a.price) as total FROM general_asset a WHERE a.room = ? AND a.status = 2 ';
        db.raw(sql,[room_print])
            //var sql = db.raw(sql,[data.date,data.username]).toSQL() คำสั่งเช็ค ค่า และคำสั่ง SQL
            .then(function(rows){
                q.resolve(rows[0][0].total)
    ...
    report_durable_room_worn_out_price_total: function(db,room_print){
        var q = Q.defer();
        var sql =   'SELECT SUM(a.price) as total FROM general_asset a WHERE a.room = ? AND a.status = 5 ';
        db.raw(sql,[room_print])
            //var sql = db.raw(sql,[data.date,data.username]).toSQL() คำสั่งเช็ค ค่า และคำสั่ง SQL
            .then(function(rows){
                q.resolve(rows[0][0].total)
    ...
    export_durable_distribute_items: function(db,items_export){
        var q = Q.defer();
        var sql =   'SELECT a.*,t.name as type_name,i.name as durable_name,CONCAT(i.code,"/",a.pieces) as items_code, '+
            'w.provide,o.shop as shop_name,r.name as room_name,s.name as status_name,r2.name as change_room_name  FROM  general_asset a '+
            'LEFT JOIN general_type t ON t.id=a.durable_type '+
    ...
    export_durable_distribute_type: function(db,type_export){
        var q = Q.defer();
        var sql =   'SELECT a.*,t.name as type_name,i.name as durable_name,CONCAT(i.code,"/",a.pieces) as items_code, '+
            'w.provide,o.shop as shop_name,r.name as room_name,s.name as status_name,r2.name as change_room_name  FROM  general_asset a '+
            'LEFT JOIN general_type t ON t.id=a.durable_type '+
    ...
    export_durable_distribute_room: function(db,room_export){
        var q = Q.defer();
        var sql =   'SELECT a.*,t.name as type_name,i.name as durable_name,CONCAT(i.code,"/",a.pieces) as items_code, '+
            'w.provide,o.shop as shop_name,r.name as room_name,s.name as status_name,r2.name as change_room_name  FROM  general_asset a '+
            'LEFT JOIN general_type t ON t.id=a.durable_type '+
