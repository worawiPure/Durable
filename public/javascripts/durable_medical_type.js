$(function(){
    ...
    var getPageType = function(){
        $.ajax({
            method:'POST',
            url:'/durable_medical/type_total',
            dataType:'json'
        })
            .success(function(data){
                ...
                $('ul[data-name="paging"]').paging(data.total, {
                    ...
                    onSelect: function (page) {
                        ...
                        $.ajax({
                            method:'POST',
                            url:'/durable_medical/start_page_type',
                            dataType:'json',
    ...
    $(document).on('click','a[data-action="remove"]', function(e){
        ...
        if(confirm('คุณต้องการลบรายการนี้ ใช่หรือไม่')){
            $.ajax({
                method:'POST',
                url:'/durable_medical/remove_type',
                dataType:'json',
                data:{
                    id:id
                }
    ...
    $('#btnSave').on('click',function(e){
        ...
        if(tname){
            if(id){
                $.ajax({
                    method:'POST',
                    url:'/durable_medical/update_type',
                    dataType:'json',
                    data:{
                        tname:tname,
                        age_l:age_l,
    ...
    $('#btnSearch').on('click', function(e){
        ...
        $.ajax({
            type: "POST",
            url: "/durable_medical/search_type",
            contentType:'application/json',
            dataType:'json',
