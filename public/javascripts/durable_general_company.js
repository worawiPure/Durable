$(function(){
    ...
    var getPageCompany = function(){
        $.ajax({
            method:'POST',
            url:'/durable_general/company_total',
            dataType:'json'
        })
            .success(function(data){
                ...
                $('ul[data-name="paging"]').paging(data.total, {
                    ...
                    onSelect: function (page) {
                        ...
                        $.ajax({
                            method:'POST',
                            url:'/durable_general/start_page_company',
                            dataType:'json',
    ...
    $(document).on('click','a[data-action="remove"]', function(e){
        ...
        if(confirm('คุณต้องการลบรายการนี้ ใช่หรือไม่')){
            $.ajax({
                method:'POST',
                url:'/durable_general/remove_company',
                dataType:'json',
                data:{
                    id:id
                }
    ...
    $('#btnSave').on('click',function(e){
        ...
        if(shop){
            if(id){
                $.ajax({
                    method:'POST',
                    url:'/durable_general/update_company',
                    dataType:'json',
                    data:{
                        shop:shop,
                        address:address,
                ...
                $.ajax({
                    method:'POST',
                    url:'/durable_general/save_company',
                    dataType:'json',
                    data:{
                        shop:shop,
                        address:address,
    ...
    $('#btnSearch').on('click', function(e){
        ...
        $.ajax({
            type: "POST",
            url: "/durable_general/search_company",
            contentType:'application/json',
            dataType:'json',
