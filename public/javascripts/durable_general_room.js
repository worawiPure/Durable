$(function(){
    ...
    var getPageRoom = function(){
        $.ajax({
            method:'POST',
            url:'/durable_general/room_total',
            dataType:'json'
        })
            .success(function(data){
                ...
                $('ul[data-name="paging"]').paging(data.total, {
                    ...
                    onSelect: function (page) {
                        ...
                        $.ajax({
                            method:'POST',
                            url:'/durable_general/start_page_room',
                            dataType:'json',
    ...
    $(document).on('click','a[data-action="remove"]', function(e){
        ...
        if(confirm('คุณต้องการลบรายการนี้ ใช่หรือไม่')){
            $.ajax({
                method:'POST',
                url:'/durable_general/remove_room',
                dataType:'json',
                data:{
                    id:id
                }
    ...
    $('#btnSave').on('click',function(e){
        ...
        if(r_name){
            if(id){
                $.ajax({
                    method:'POST',
                    url:'/durable_general/update_room',
                    dataType:'json',
                    data:{
                        r_name:r_name,
                        id:id
    ...
    $('#btnSearch').on('click', function(e){
        ...
        $.ajax({
            type: "POST",
            url: "/durable_general/search_room",
            contentType:'application/json',
            dataType:'json',
