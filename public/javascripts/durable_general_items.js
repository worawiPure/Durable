$(function(){
    ...
    var getPageItems = function(){
        $.ajax({
            method:'POST',
            url:'/durable_general/items_total',
            dataType:'json'
        })
            .success(function(data){
                ...
                $('ul[data-name="paging"]').paging(data.total, {
                    ...
                    onSelect: function (page) {
                        ...
                        $.ajax({
                            method:'POST',
                            url:'/durable_general/start_page_items',
                            dataType:'json',
    ...
    $(document).on('click','a[data-action="remove"]', function(e){
        ...
        if(confirm('คุณต้องการลบรายการนี้ ใช่หรือไม่')){
            $.ajax({
                method:'POST',
                url:'/durable_general/remove_items',
                dataType:'json',
                data:{
                    id:id
                }
    ...
    $('#btnSave').on('click',function(e){
        ...
        if(items_name){
            if(id){
                $.ajax({
                    method:'POST',
                    url:'/durable_general/update_items',
                    dataType:'json',
                    data:{
                ...
                $.ajax({
                    method:'POST',
                    url:'/durable_general/save_items',
                    dataType:'json',
                    data:{
                        items_name:items_name,
                        code:code
    ...
    $('#btnSearch').on('click', function(e){
        ...
        $.ajax({
            type: "POST",
            url: "/durable_general/search_items",
            contentType:'application/json',
            dataType:'json',
