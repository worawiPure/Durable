$(function() {
    ...
    var setTable = function(data){
        ...
        _.forEach(data.rows, function(v){
            ...
            var html = '<tr> ' +
                ...
                'data-change_room2="'+ v.change_room  +'" data-distribute_date2= "'+ moment(v.distribute_date_thai).format('DD/MM/YYYY')+'" data-status2="'+ v.status +'" ' +
    ...
    $('#btnSearch_items').on('click', function(e){
        ...
        if(!data.items) {
            ...
            $.ajax({
                type: "POST",
                url: "/general_add_asset/durable_search_items",
    ...
    $('#btnSearch_type').on('click', function(e){
        ...
        if(!data.type) {
            ...
            $.ajax({
                type: "POST",
                url: "/general_add_asset/durable_search_type",
                contentType: 'application/json',
                data: JSON.stringify(data)
            })
                .success(function(data) {
    ...
    $('#btnSearch_room').on('click', function(e){
        ...
        if(!data.room) {
            ...
            $.ajax({
                type: "POST",
                url: "/general_add_asset/durable_search_room",
                contentType: 'application/json',
                data: JSON.stringify(data)
            })
                .success(function(data) {
    ...
    $('#btnPrint_type').on('click', function(e){
        ...
        window.open('/prints/report_general_type/'+type_print)
    });
